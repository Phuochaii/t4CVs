    ...
    <main className="flex items-start justify-center gap-8 p-2 py-8 text-black bg-neutral-200">
      <div className="flex w-[45%] flex-col gap-4 p-4 bg-white rounded-lg">
        ...
        <div className="flex items-center gap-2 text-sm">
          <span className="text-red-500">(*)</span>Các thông tin bắt
          buộc
        </div>
      ...
      <div className="flex flex-col p-2 divide-y gap-6 bg-white rounded-lg max-w-[400px]">
        <div className="flex gap-6">
          ...
          <div className="flex flex-col items-start gap-2">
            ...
            <button className="flex items-center gap-2 px-2 py-1 text-sm font-bold rounded-full bg-slate-200">
              <ArrowUpCircle size={16}></ArrowUpCircle>Nâng cấp tài
              khoản
            </button>
          </div>
        </div>
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-gray-400">
            Bật tìm việc giúp hồ sơ của bạn nổi bật hơn và được chú ý
            nhiều hơn trong danh sách tìm kiếm của NTD
          </p>
          <div className="flex items-center gap-2">
            <Switch
              checked={availble}
          ...
          <p>
            Khi có cơ hội việc làm phù hợp, NTD sẽ liên hệ và trao đổi
            với bạn qua:
          </p>
        ...
        <div className="flex flex-col items-start gap-4 py-2">
          <div className="flex items-start gap-2">
            ...
            Khởi tạo TopCV Profile để gia tăng 300% cơ hội việc làm
            tốt
          </div>
