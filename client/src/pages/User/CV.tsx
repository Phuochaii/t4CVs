                ...
                <div className="bg-white rounded-lg p-5 md:p-6 mb-5">
                    <div>
                        <div className="flex flex-row items-center space-x-10">
                            ...
                            <div className="px-1 rounded-sm bg-orange-400 text-white">Mới</div>
                        </div>
                    ...
                    <div className="mt-5">
                        ...
                        <div className="flex flex-row items-start w-full p-1 bg-gray-200 space-x-1">
                            <CircleAlert style={{ transform: 'rotate(180deg)', width: 15, height: 15, marginBottom: 2 }}></CircleAlert>
                            <p className="text-[10px]">Ví dụ: Để ẩn hồ sơ của bạn với NTD có email <span className="text-[10px] underline underline-offset-1">admin@tenmiencongty.com</span>, vui lòng nhập <p className="text-[10px] underline underline-offset-1">tenmiencongty.com</p>.</p>
                        </div>
                    </div>
