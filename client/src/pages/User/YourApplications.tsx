              ...
              >
                ...
                <div className="job-detail w-full h-full">
                  ...
                  <div className='flex justify-between items-center'>
                    <p className='font-light'>CV đã ứng tuyển: <span className='font-normal text-green-500 underline'>TopCV</span></p>
                  ...
                  <div className='flex justify-between mt-5 border-t-2'>
                    <p>Trạng thái: <span className={`font-bold ${item.status === "NTD đã xem" ? "text-orange-500" : "text-blue-500"}`}>{item.status}</span></p>
...
function YourApplications() {
  ...
  const [applications, setApplication] = useState<ApplicationFromServer[] | undefined>([])
                ...
                return (
                  ...
                  >
                      <img
                        ...
                        src={
                          jobs!.find(e => e.campaignId === item.campaignId)?.company.image
                        }
                      />
                    <div className="job-detail w-full h-full">
                      <div className="flex flex-col">
                        <div className="flex flex-row justify-between">
                          <span className="job-title text-black font-semibold col-span-3 text-lg">
                            {jobs!.find(e => e.campaignId === item.campaignId)?.titleRecruitment}
                          </span>
                          <div className="job-salary col-start-4 flex items-center">
                            <CurrencyDollarIcon className="w-5 mr-2" />
                            <strong className="salary-count">
                              {jobs!.find(e => e.campaignId === item.campaignId)?.salaryMin} - {jobs!.find(e => e.campaignId === item.campaignId)?.salaryMax}
                            </strong>
                          </div>
                        </div>
                        <span className="job-company-name text-slate-600 text-sm col-span-3 mb-2">
                      ...
                      <div className='flex justify-between mt-5 border-t-2'>
                        <p>Trạng thái: <span className={`font-bold ${item.status === true ? "text-orange-500" : "text-blue-500"}`}>{item.status === true ?"NTD đã xem":"Đã ứng tuyển"}</span></p>
      ...
      <div className="w-3/12 m-8 flex flex-col">
        <div className="bg-white rounded-lg p-5 md:p-6 mb-5">
          ...
          <div className="flex flex-col border-t-2 border-gray mt-4">
            ...
            <button className="mt-4 px-4 py-2 text-xs font-bold w-40 h-8 border border-green-500 rounded text-green-500 hover:bg-green-500 hover:text-white transition duration-300" onClick={() => { }}>
              Tạo TopCV Profile
            </button>
          </div>
        </div>
