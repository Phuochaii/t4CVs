...
function ApplyCV() {
  ...
  const handleFileInputChange = (event) => {
    ...
    if (file && file.size <= 5 * 1024 * 1024) { // 5MB limit
      ...
      if (fileType === 'application/msword' || // .doc
                  ...
                  <div className="job-detail__info mt-4 bg-white text-black rounded-lg py-2 px-4 grid grid-rows-4 items-center">
                    ...
                    <div className="job-detail__info--sub-details flex flex-rows gap-x-4">
                      ...
                      <div className="job-detail__info--deadline max-h-8 col-span-2 flex flex-rows items-center text-sm text-slate-500 p-2 bg-slate-100 rounded-lg">
                        ...
                        Hạn nộp hồ sơ:{" "}
                        {moment.utc(jobData?.expiredDate ? jobData?.expiredDate : "").format("DD/MM/YYYY")}
                      </div>
                    </div>
                    ...
                    {!selectedFile ? 
                      ...
                      <div className="input-inner flex flex-col gap-3 w-max m-auto">
                        ...
                        <div className="selected-file-detail flex flex-row gap-2 items-center justify-center text-green-500">
                          <svg className="w-8 h-8" fill="rgb(34 197 94)" viewBox="-6.5 0 32 32" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <p className="truncate max-w-52">{selectedFile?.name}</p>
                          <span
                            className="delete-btn bg-red-100 rounded-md p-1 px-2"
                            onClick={handleDeleteFile}>
                            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7 4a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v2h4a1 1 0 1 1 0 2h-1.069l-.867 12.142A2 2 0 0 1 17.069 22H6.93a2 2 0 0 1-1.995-1.858L4.07 8H3a1 1 0 0 1 0-2h4V4zm2 2h6V4H9v2zM6.074 8l.857 12H17.07l.857-12H6.074zM10 10a1 1 0 0 1 1 1v6a1 1 0 1 1-2 0v-6a1 1 0 0 1 1-1zm4 0a1 1 0 0 1 1 1v6a1 1 0 1 1-2 0v-6a1 1 0 0 1 1-1z" fill="rgb(239 68 68)"/></svg>
                          </span>
                          <span
