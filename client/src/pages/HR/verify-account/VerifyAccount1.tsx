            ...
            <div className="main mt-4 mx-11 bg-white w-full text-center pt-6 pb-10 px-36">
                ...
                <div className="flex items-center justify-center gap-1">
                    ...
                    <span className="font-semibold text-black text-base">
                        Hãy chủ động thực hiện xác thực eKYC cùng TopCV
                    </span>
                </div>
                <div className="text-black">
                    Hướng tới tăng cường bảo mật cùng gia tăng uy tín cho tài
                    khoản của Quý khách hàng,
                    <br /> TopCV mong muốn và khuyến khích Quý khách chủ động
                    thực hiện Xác thực tài khoản điện tử - eKYC trên hệ thống.
                </div>
                <a
