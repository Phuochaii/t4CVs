    ...
    return (
      <div>
        ...
        <div
            ...
            style={{
                flexGrow: 3,
            backgroundImage: "linear-gradient(#e1fbed, white)",
            }}
        >
            <img
            className="w-full"
            ...
            Hoạt động tuyển dụng của doanh nghiệp được tiến hành theo từng
            giai đoạn
            <br /> với các mục tiêu tuyển dụng khác nhau. Chiến .topcv.v
        ...
        <div className=" pl-7" style={{flexGrow:2}}>
            ...
            <div className="ref_description">
                Hiểu về cách chiến dịch tuyển dụng hoạt động sẽ giúp bạn tối
                ưu tốt hơn hoạt động tuyển dụng của doanh nghiệp trên TopCV.
                Hãy chắc chắn bạn đã tìm hiểu thông tin về chiến dịch tuyển
                dụng.
            </div>
            ...
            <div className="modal-content">
              ...
              <div className="p-6 flex justify-center flex-col ">
                ...
                <div className="text-base  text-neutral-700 text-center">
                  Chúng tôi gợi ý những hoạt động bên dưới. Hãy lựa chọn hoạt
                  động phù hợp.
                </div>
              </div>
