  ...
  return (
    <div className="flex flex-col gap-4 p-4 bg-white">
      <p>
        ...
        quyền lợi dành cho các Khách hàng Doanh nghiệp chỉ có ở TopCV. Đây là
        ...
        <div className="flex flex-col gap-4 py-4 border-t">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span>
              ...
              <span className="font-bold text-red-400">{'>= 3'}</span> dụng miễn
              phí hiển thị đồng thời, để được TopCV duyệt hiển thị tin tuyển
              dụng này, vui lòng sử dụng một trong các gói tin đăng cao cấp
            </span>
          </div>
  ...
  const sections = [
    {
      ...
      sectionComponent: (
        <CampaignEditCard jobItem={job} fields={fields}></CampaignEditCard>
      ),
