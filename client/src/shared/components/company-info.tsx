  ...
  const companies = [
    {
      ...
      address: '316 Chánh Hưng, Phường 5, Quận 8',
      field: 'Lập trình phần mềm',
    },
    {
      id: 2,
      ...
      address: '170/2 Đường Nguyễn Xí, Quận 26',
      field: 'Khác',
    },
    {
      id: 3,
    ...
    <div className="w-full m-10 flex flex-col">
      ...
      <div className="flex flex-col w-11/12 border-slate-200 border-2 p-5">
        <div className="flex flex-row items-center space-x-2">
          ...
          <button className="text-sm btn-success py-3 px-8 rounded text-white bg-green-500 shadow-md cursor-pointe rounded-full">
            Tìm kiếm
          </button>
        </div>
