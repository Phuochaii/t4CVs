    ...
    <header className="menu-top bg-white text-black">
      <div className="container px-8 flex flex-row justify-between items-center">
        <div className="main flex flex-row items-center gap-5">
          ...
          <nav className="nav-menu">
            <ul className="flex flex-row items-center">
              ...
              >
                <a href="#" className="font-semibold text-base px-6 py-8 hover:text-green-500" >
                  Việc làm
                </a>
                {isJobsHovered ?
                  <ul className="sub-menu absolute z-50 top-full left-0 font-semibold text-base bg-white border border-slate-100 rounded-lg p-3 flex flex-col gap-3 shadow-lg">
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14.5 14.5L10.5 10.5M6.5 12.5C3.18629 12.5 0.5 9.81371 0.5 6.5C0.5 3.18629 3.18629 0.5 6.5 0.5C9.81371 0.5 12.5 3.18629 12.5 6.5C12.5 9.81371 9.81371 12.5 6.5 12.5Z" stroke="rgb(34 197 94)"/>
                      </svg>
                      Tìm việc làm
                    </li>
                    <li><hr /></li>
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6" fill="rgb(34 197 94)" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-7 h-7" fill="rgb(34 197 94)" viewBox="-2 -4 24 24" xmlns="http://www.w3.org/2000/svg"><path d='M3.636 7.208L10 13.572l6.364-6.364a3 3 0 1 0-4.243-4.243L10 5.086l-2.121-2.12a3 3 0 0 0-4.243 4.242zM9.293 1.55l.707.707.707-.707a5 5 0 1 1 7.071 7.071l-7.07 7.071a1 1 0 0 1-1.415 0l-7.071-7.07a5 5 0 1 1 7.07-7.071z'/></svg>
                      Việc làm đã lưu
                    </li>
                    <li><hr /></li>
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                    <svg className="w-5 h-5" fill="rgb(34 197 94)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1200">
                    <path id="path3015" inkscape:connector-curvature="0" d="M0,0v775.711V1200h424.289
                    ...
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6" fill="rgb(34 197 94)" viewBox="0 -64 640 640" xmlns="http://www.w3.org/2000/svg"><path d="M255.03 261.65c6.25 6.25 16.38 6.25 22.63 0l11.31-11.31c6.25-6.25 6.25-16.38 0-22.63L253.25 192l35.71-35.72c6.25-6.25 6.25-16.38 0-22.63l-11.31-11.31c-6.25-6.25-16.38-6.25-22.63 0l-58.34 58.34c-6.25 6.25-6.25 16.38 0 22.63l58.35 58.34zm96.01-11.3l11.31 11.31c6.25 6.25 16.38 6.25 22.63 0l58.34-58.34c6.25-6.25 6.25-16.38 0-22.63l-58.34-58.34c-6.25-6.25-16.38-6.25-22.63 0l-11.31 11.31c-6.25 6.25-6.25 16.38 0 22.63L386.75 192l-35.71 35.72c-6.25 6.25-6.25 16.38 0 22.63zM624 416H381.54c-.74 19.81-14.71 32-32.74 32H288c-18.69 0-33.02-17.47-32.77-32H16c-8.8 0-16 7.2-16 16v16c0 35.2 28.8 64 64 64h512c35.2 0 64-28.8 64-64v-16c0-8.8-7.2-16-16-16zM576 48c0-26.4-21.6-48-48-48H112C85.6 0 64 21.6 64 48v336h512V48zm-64 272H128V64h384v256z"/></svg>
                      Việc làm IT
                    </li>
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6" fill="rgb(34 197 94)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 280.003 280.003">
                  ...
                  <ul className="sub-menu absolute z-50 top-full left-0 font-semibold text-base bg-white border border-slate-100 rounded-lg p-3 flex flex-col gap-3 shadow-lg">
                    ...
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 9C10.8954 9 10 9.89543 10 11C10 12.1046 10.8954 13 12 13C13.1046 13 14 12.1046 14 11C14 9.89543 13.1046 9 12 9Z" fill="rgb(34 197 94)"/>
                        <path d="M8 17.5C8 15.8431 9.34315 14.5 11 14.5H13C14.6569 14.5 16 15.8431 16 17.5C16 18.0523 15.5523 18.5 15 18.5H9C8.44772 18.5 8 18.0523 8 17.5Z" fill="rgb(34 197 94)"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7 2.25C5.48122 2.25 4.25 3.48122 4.25 5V19C4.25 20.5188 5.48122 21.75 7 21.75H17C18.5188 21.75 19.75 20.5188 19.75 19V8.1979C19.75 7.83178 19.6352 7.47488 19.4217 7.17745L16.4085 2.97955C16.0798 2.52157 15.5506 2.25 14.9868 2.25H7ZM5.75 5C5.75 4.30964 6.30964 3.75 7 3.75H14.25V8.14705C14.25 8.56126 14.5858 8.89705 15 8.89705H18.25V19C18.25 19.6904 17.6904 20.25 17 20.25H7C6.30964 20.25 5.75 19.6904 5.75 19V5Z" fill="rgb(34 197 94)"/>
                      </svg>
                      Quản lý CV
                    </li>
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6" fill="rgb(34 197 94)" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M8.71,7.71,11,5.41V15a1,1,0,0,0,2,0V5.41l2.29,2.3a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42l-4-4a1,1,0,0,0-.33-.21,1,1,0,0,0-.76,0,1,1,0,0,0-.33.21l-4,4A1,1,0,1,0,8.71,7.71ZM21,12a1,1,0,0,0-1,1v6a1,1,0,0,1-1,1H5a1,1,0,0,1-1-1V13a1,1,0,0,0-2,0v6a3,3,0,0,0,3,3H19a3,3,0,0,0,3-3V13A1,1,0,0,0,21,12Z"/></svg>
                      Tải CV lên
                    </li>
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6" fill="rgb(34 197 94)" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6 pl-1" fill="rgb(34 197 94)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              >
                ...
                {isCompaniesHovered ?
                  <ul className="sub-menu absolute z-50 top-full left-0 font-semibold text-base bg-white border border-slate-100 rounded-lg p-3 flex flex-col gap-3 shadow-lg">
                    ...
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path fill="rgb(34 197 94)" d="M252.5 381l-128 49c-5.9 2.2-12.1-2.3-11.8-8.6l7-136.9c.1-2.1-.6-4.2-1.9-5.9L31.6 172c-4-4.9-1.6-12.2 4.5-13.9l132.4-35.6c2.1-.6 3.9-1.9 5-3.7L248.3 4c3.4-5.3 11.2-5.3 14.6 0l74.8 114.9c1.2 1.8 3 3.1 5 3.7l132.4 35.6c6.1 1.6 8.5 9 4.5 13.9l-86.1 106.6c-1.3 1.7-2 3.8-1.9 5.9l7 136.9c.3 6.3-5.9 10.8-11.8 8.6l-128-49c-2.1-.8-4.3-.8-6.3-.1z"></path><path fill="rgb(74 222 128)" d="M456.1 51.7l-41-41c-1.2-1.2-2.8-1.7-4.4-1.5c-1.6.2-3.1 1.2-3.9 2.6l-42.3 83.3c-1.2 2.1-.8 4.6.9 6.3c1 1 2.4 1.5 3.7 1.5c.9 0 1.8-.2 2.6-.7L454.9 60c1.4-.8 2.4-2.2 2.6-3.9c.3-1.6-.3-3.2-1.4-4.4z"></path><path fill="rgb(74 222 128)" d="M149.1 95.2l-42.3-83.3c-.8-1.4-2.2-2.4-3.9-2.6c-1.6-.2-3.3.3-4.4 1.5l-41 41c-1.2 1.2-1.7 2.8-1.5 4.4c.2 1.6 1.2 3.1 2.6 3.9l83.3 42.3c.8.5 1.7.7 2.6.7c1.4 0 2.7-.5 3.7-1.5c1.7-1.8 2-4.4.9-6.4z"></path><path fill="rgb(74 222 128)" d="M289.8 505.2l-29-88.8c-.2-.9-.7-1.7-1.3-2.3c-1-1-2.3-1.5-3.7-1.5c-2.4 0-4.4 1.6-5.1 3.9l-29 88.8c-.4 1.6-.1 3.3.9 4.6c1 1.3 2.5 2.1 4.2 2.1h57.9c1.6 0 3.2-.8 4.2-2.1c1.1-1.4 1.4-3.1.9-4.7z"></path></svg>
                      Top công ty
                    </li>
                  </ul>
                  : <></>
                ...
                {isToolsHovered ?
                  <div className="grid grid-cols-2 absolute z-50 top-full left-0 w-[720px] font-semibold text-base bg-white border border-slate-100 rounded-lg shadow-lg">
                    <ul className="sub-menu p-3 flex flex-col gap-3">
                      ...
                      <li><hr /></li>
                      <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6" fill="rgb(34 197 94)" viewBox="-2.5 -2.5 24 24" xmlns="http://www.w3.org/2000/svg"><path d='M12.238 5.472L3.2 14.51l-.591 2.016 1.975-.571 9.068-9.068-1.414-1.415zM13.78 3.93l1.414 1.414 1.318-1.318a.5.5 0 0 0 0-.707l-.708-.707a.5.5 0 0 0-.707 0L13.781 3.93zm3.439-2.732l.707.707a2.5 2.5 0 0 1 0 3.535L5.634 17.733l-4.22 1.22a1 1 0 0 1-1.237-1.241l1.248-4.255 12.26-12.26a2.5 2.5 0 0 1 3.535 0z'/></svg>
                        TopCV Skills
                      </li>
                      <li><hr /></li>
                      <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                        <svg className="w-6 h-6" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M4 13L24 8L44 13L24 18L4 13Z" stroke="rgb(34 197 94)" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                          <path d="M13 16V25.9706C13 25.9706 18 29 24 29C30 29 35 25.9706 35 25.9706V16" stroke="rgb(34 197 94)" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                          <path d="M7 14V36" stroke="rgb(34 197 94)" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                          <rect x="4" y="34" width="6" height="6" fill="none" stroke="rgb(34 197 94)" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        Khóa học
                      </li>
                      <li><hr /></li>
                      <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                        <svg className="w-6 h-6" fill="rgb(34 197 94)" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul className="sub-menu p-3 flex flex-col gap-3">
                      <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                        <svg className="w-6 h-6" fill="rgb(34 197 94)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                      ...
                      <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                        <svg className="w-6 h-6" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                          <path fill="rgb(34 197 94)" d="M5 11h3v5h-3v-5z"></path>
                          <path fill="rgb(34 197 94)" d="M1 14h3v2h-3v-2z"></path>
                          <path fill="rgb(34 197 94)" d="M13 12h3v4h-3v-4z"></path>
                          <path fill="rgb(34 197 94)" d="M9 9h3v7h-3v-7z"></path>
                          <path fill="rgb(34 197 94)" d="M16 0.070l-5.68 4.97-5.47-1.7-4.85 3.76v1.9l5.15-4 5.53 1.72 5.32-4.66v-1.99z"></path>
                        </svg>
                        Tính thuế thu nhập cá nhân
                      </li>
                      <li><hr /></li>
                      <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                        <svg className="w-6 h-6" fill="rgb(34 197 94)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 317.855 317.855">
                      ...
                      <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M13 5C13 6.10457 10.5376 7 7.5 7C4.46243 7 2 6.10457 2 5M13 5C13 3.89543 10.5376 3 7.5 3C4.46243 3 2 3.89543 2 5M13 5V6.5M2 5V17C2 18.1046 4.46243 19 7.5 19M7.5 11C7.33145 11 7.16468 10.9972 7 10.9918C4.19675 10.9 2 10.0433 2 9M7.5 15C4.46243 15 2 14.1046 2 13M22 11.5C22 12.6046 19.5376 13.5 16.5 13.5C13.4624 13.5 11 12.6046 11 11.5M22 11.5C22 10.3954 19.5376 9.5 16.5 9.5C13.4624 9.5 11 10.3954 11 11.5M22 11.5V19C22 20.1046 19.5376 21 16.5 21C13.4624 21 11 20.1046 11 19V11.5M22 15.25C22 16.3546 19.5376 17.25 16.5 17.25C13.4624 17.25 11 16.3546 11 15.25" stroke="rgb(34 197 94)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        Tính lãi xuất kép
                      </li>
                      <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                        <svg className="w-6 h-6" fill="rgb(34 197 94)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 481 481">
              ...
              >
                ...
                {isSupportsHovered ?
                  <ul className="sub-menu absolute z-50 top-full left-0 font-semibold text-base bg-white border border-slate-100 rounded-lg p-3 flex flex-col gap-3 shadow-lg">
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6" fill="rgb(34 197 94)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" >
                    ...
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13 7L11.8845 4.76892C11.5634 4.1268 11.4029 3.80573 11.1634 3.57116C10.9516 3.36373 10.6963 3.20597 10.4161 3.10931C10.0992 3 9.74021 3 9.02229 3H5.2C4.0799 3 3.51984 3 3.09202 3.21799C2.71569 3.40973 2.40973 3.71569 2.21799 4.09202C2 4.51984 2 5.0799 2 6.2V7M2 7H17.2C18.8802 7 19.7202 7 20.362 7.32698C20.9265 7.6146 21.3854 8.07354 21.673 8.63803C22 9.27976 22 10.1198 22 11.8V16.2C22 17.8802 22 18.7202 21.673 19.362C21.3854 19.9265 20.9265 20.3854 20.362 20.673C19.7202 21 18.8802 21 17.2 21H6.8C5.11984 21 4.27976 21 3.63803 20.673C3.07354 20.3854 2.6146 19.9265 2.32698 19.362C2 18.7202 2 17.8802 2 16.2V7ZM15.5 17.5L14 16M15 13.5C15 15.433 13.433 17 11.5 17C9.567 17 8 15.433 8 13.5C8 11.567 9.567 10 11.5 10C13.433 10 15 11.567 15 13.5Z" stroke="rgb(34 197 94)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                      </svg>
                      Bí kíp tìm việc
                    </li>
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6" fill="rgb(34 197 94)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 485 485">
                    ...
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6" fill="rgb(34 197 94)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54 54">
                    ...
                    <li className="p-4 text-slate-800 rounded bg-slate-100 flex flex-row gap-3 w-96 hover:text-green-600 hover:bg-slate-200 cursor-pointer">
                      <svg className="w-6 h-6" fill="rgb(34 197 94)" viewBox="0 0 256 256">
        ...
        <div className="user-actions justify-end flex flex-row gap-3">
          <span className="btn-notice bg-green-100 p-2 rounded-full cursor-pointer">
            <svg
              fill="rgb(22 163 74)"
              className="w-8 h-8"
              viewBox="0 0 36 36"
          ...
          <span className="btn-message bg-green-100 p-2 rounded-full cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="rgb(22 163 74)"
